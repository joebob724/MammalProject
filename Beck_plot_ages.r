...
Primates_mrca <- mrca_table[which(rownames(mrca_table) == "Purgatorius"), which(colnames(mrca_table) == "Adapsis")]
Carnivora_mrca <- mrca_table[which(rownames(mrca_table) == "Proticitus"), which(colnames(mrca_table) == "Miacis")]
...
Euarchonta_mrca <- mrca_table[which(rownames(mrca_table) == "Cynocephalus"), which(colnames(mrca_table) == "Adapsis")]
...
Euarchonta_mrca <- mrca_table[which(rownames(mrca_table) == "Ptilocercus"), which(colnames(mrca_table) == "Adapsis")]
Ferae_mrca <- mrca_table[which(rownames(mrca_table) == "Patriomanis"), which(colnames(mrca_table) == "Miacis")]
